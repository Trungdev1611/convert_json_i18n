...
`;
  ...
  const handleExportForTypeGeneration = () => {
    ...
    message.success(
      'Đã tải xuống en.json, jp.json, malay.json. Copy vào src/translate/ để generate types!'
    );
    setIsModalOpen(false);
  };
...
`;
    ...
    message.success(
      `Đã tải xuống tất cả files: en.json, jp.json, malay.json, translations.d.ts (${enKeys.length} keys)`
    );
    setIsModalOpen(false);
  };
  ...
  return (
    <>
      <Card
        ...
        extra={
          <Button type="primary" icon={<DownloadOutlined />} onClick={() => setIsModalOpen(true)}>
            Chọn loại download
          </Button>
        }
      >
        <Paragraph className="text-gray-600 mb-0">
          <strong>Mô tả:</strong> Tải xuống các file JSON đã được dịch và cập nhật, hoặc TypeScript
          type definition. Bạn có thể tải xuống từng file riêng lẻ (EN.json, JP.json, Malay.json),
          tải xuống tất cả trong 1 file (all_translations.json), hoặc download type definition
          (translations.d.ts) để dùng trong project khác.
        </Paragraph>
      </Card>
        ...
        <Space direction="vertical" size="large" className="w-full">
          ...
          <div>
            <Text strong className="text-base block mb-2">
              ✨ Download Tất Cả Files Cho Project Mới (Khuyến nghị)
            </Text>
            <Paragraph className="text-gray-600 text-sm mb-3">
              <strong>Workflow đơn giản nhất:</strong> Upload Excel → Download tất cả files → Copy
              vào project mới → Dùng ngay!
              <br />
              Tool sẽ tự động download <strong>4 files</strong>:
              <ul className="list-disc ml-5 mt-1">
                <li>
                  <code className="bg-gray-100 px-1 rounded">en.json</code> - Copy vào{' '}
                  <code className="bg-gray-100 px-1 rounded">src/translate/en.json</code>
                </li>
                <li>
                  <code className="bg-gray-100 px-1 rounded">jp.json</code> - Copy vào{' '}
                  <code className="bg-gray-100 px-1 rounded">src/translate/jp.json</code>
                </li>
                <li>
                  <code className="bg-gray-100 px-1 rounded">malay.json</code> - Copy vào{' '}
                  <code className="bg-gray-100 px-1 rounded">src/translate/malay.json</code>
                </li>
                <li>
                  <code className="bg-gray-100 px-1 rounded">translations.d.ts</code> - Copy vào{' '}
                  <code className="bg-gray-100 px-1 rounded">src/types/translations.d.ts</code>
                </li>
              </ul>
            ...
            <Paragraph className="text-xs text-gray-500 text-center mt-2 mb-0">
              💡 Lưu ý: Sẽ download 4 files riêng biệt. Để preview, hãy dùng các nút Preview ở các
              section bên dưới.
            </Paragraph>
          </div>
          ...
          <div>
            <Text strong className="text-base block mb-2">
              Tải xuống tất cả (Recommended)
            </Text>
            <Paragraph className="text-gray-600 text-sm mb-3">
              Tải xuống 1 file duy nhất chứa tất cả 3 ngôn ngữ (en, jp, malay) trong cùng một
              object. File này phù hợp khi bạn muốn quản lý tất cả translations trong một nơi.
            </Paragraph>
          ...
          <div>
            <Text strong className="text-base block mb-2">
              Tải xuống từng file riêng
            </Text>
            <Paragraph className="text-gray-600 text-sm mb-3">
              Tải xuống từng file JSON riêng biệt cho từng ngôn ngữ. Phù hợp khi bạn cần sử dụng
              từng file độc lập trong dự án.
            </Paragraph>
          ...
          <div>
            <Text strong className="text-base block mb-2">
              Export JSON Files cho Script Generate Types
            </Text>
            <Paragraph className="text-gray-600 text-sm mb-3">
              <strong>Cho CI/CD và automation:</strong> Tải xuống các file JSON với tên đúng (
              <code className="bg-gray-100 px-1 rounded">en.json</code>,{' '}
              <code className="bg-gray-100 px-1 rounded">jp.json</code>,{' '}
              <code className="bg-gray-100 px-1 rounded">malay.json</code>) từ localStorage để copy
              vào thư mục <code className="bg-gray-100 px-1 rounded">src/translate/</code> trong
              project, sau đó chạy script Node.js để generate types tự động trong build process.
              <br />
              <br />
              ...
              <ol className="list-decimal ml-5 mt-1">
                ...
                <li>
                  Copy các file vào <code className="bg-gray-100 px-1 rounded">src/translate/</code>{' '}
                  trong project
                </li>
                <li>
                  Chạy:{' '}
                ...
                <li>
                  File <code className="bg-gray-100 px-1 rounded">src/types/translations.d.ts</code>{' '}
                  sẽ được tạo tự động
                </li>
              </ol>
            </Paragraph>
          ...
          <div>
            <Text strong className="text-base block mb-2">
              Download TypeScript Type Definition (Từ localStorage)
            </Text>
            <Paragraph className="text-gray-600 text-sm mb-3">
              <strong>✨ Cách đơn giản nhất:</strong> Generate và download file{' '}
              <code className="bg-gray-100 px-1 rounded">translations.d.ts</code> trực tiếp từ
              localStorage trong browser.
              <strong className="text-green-600"> Không cần Node.js!</strong>
              <br />
              File này chứa tất cả translation keys (bao gồm nested keys) với type-safe cho
              TypeScript, giúp auto-complete và type checking khi code.
              <br />
              <br />
              <strong>Cách dùng:</strong>
              <ol className="list-decimal ml-5 mt-1">
                <li>
                  Click button bên dưới để download{' '}
              ...
              <br />
              <strong>💡 Lưu ý:</strong> Nếu bạn muốn tự động hóa trong CI/CD hoặc build process,
              hãy dùng cách "Export cho Type Generation" ở trên và chạy script Node.js.
            </Paragraph>
            <Space className="w-full" direction="vertical">
              <Button
                type="default"
