# 🔄 Luồng Flow của i18n Tool

## Tổng quan

Tool có **2 cách độc lập** để generate TypeScript types. Bạn chỉ cần chọn 1 cách phù hợp với nhu cầu.
...
└─────────────────────────────────────────────────────────────┘
        ...
        ▼                                     ▼
┌──────────────────────┐          ┌──────────────────────┐
│   CÁCH 1 (Khuyến nghị)│          │   CÁCH 2 (Cho CI/CD) │
│   Không cần Node.js   │          │   Cần Node.js        │
└──────────────────────┘          └──────────────────────┘
        │                                     │
        ▼                                     ▼
┌──────────────────────┐          ┌──────────────────────┐
│ Click button:         │          │ Click button:         │
│ "Download            │          │ "Export JSON Files"    │
│ translations.d.ts"   │          │                       │
└──────────────────────┘          └──────────────────────┘
        │                                     │
        ▼                                     ▼
┌──────────────────────┐          ┌──────────────────────┐
│ Tool tự động:         │          │ Download 3 files:     │
│ - Đọc localStorage   │          │ - en.json            │
│ - Flatten keys        │          │ - jp.json            │
│ - Generate types      │          │ - malay.json         │
│ - Download file       │          └──────────────────────┘
└──────────────────────┘                    │
        │                                   ▼
        │                    ┌──────────────────────┐
...
4. Chạy: `node scripts/generate-translation-types.cjs`
5. File `translations.d.ts` được tạo tự động
6. Done! ✅
